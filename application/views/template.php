...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?=base_url('dashboard')?>" class="logo">
      ...
      <span class="logo-lg"><b>Laundry</b>Kenangan</span>
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?=site_url('auth/logout')?>" onclick="return confirm('are you sure?')"  class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($this->session->userdata('level') == 1 ) { ?>
        <li <?=$this->uri->segment(1) == 'paket' ? 'class="active"' : '' ?>>
          <a href="<?=site_url('paket')?>">
            <i class="fa fa-cube"></i> <span>Jenis Paket</span>
          </a>
        </li>
      ...
      <?php } ?>
          ...
          <a onclick="return confirm('are you sure?')" href="<?=site_url('Auth/logout')?>">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://adminlte.io">Laundry Kenangan</a>.</strong> Perograman Framework Paralel A
  </footer>
